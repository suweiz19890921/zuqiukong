...
#define WPedding 15
#define thisHeight [UIScreen mainScreen].bounds.size.height
#define thisWidth [UIScreen mainScreen].bounds.size.width
...
- (void)configCapture
{
    ...
    _previewLayer.frame = CGRectMake(0, 0, thisWidth, thisHeight);
