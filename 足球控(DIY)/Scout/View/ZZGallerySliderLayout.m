...
-(id)init
{
    self = [super init];
    if (self) {
        self.itemSize = CGSizeMake(375, CELL_HEIGHT);
...
#warning contentoffset
-(CGSize)collectionViewContentSize
{
    return CGSizeMake(CELL_WIDTH, HEADER_HEIGHT+DRAG_INTERVAL*self.count+([UIScreen mainScreen].bounds.size.height-DRAG_INTERVAL - 1850));
}
